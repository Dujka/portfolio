      ...
      <div class="container mx-auto px-6">
        <div class="sm:flex sm:mt-8">
          <div class="mt-8 sm:mt-0 sm:w-full sm:px-8 flex flex-col md:flex-row justify-between">
            <div class="flex flex-col flex-grow w-full">
              ...
              <span className="my-2">
                ...
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  href="https://goo.gl/maps/x3fGCgoDZEDp9RXC7"
                >
                  Zorana Radmilovića 17, 19370, Boljevac, Serbia
                </a>
              </span>
              <span className="my-2">
            ...
            <div class="flex flex-col flex-grow w-full">
              <span class="font-bold uppercase mt-8 md:mt-0 mb-4">
                You can find me on
              </span>
              <span class="flex flex-wrap justify-between my-2">
                <a
                  className="mx-auto hover:text-blue-300 transition"
                  rel="noreferrer"
                  target="_blank"
